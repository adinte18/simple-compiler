...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OPAR = 9,                       /* OPAR  */
  YYSYMBOL_CPAR = 10,                      /* CPAR  */
  YYSYMBOL_ID = 11,                        /* ID  */
  YYSYMBOL_NUM = 12,                       /* NUM  */
  YYSYMBOL_UMINUS = 13,                    /* UMINUS  */
  YYSYMBOL_YYACCEPT = 14,                  /* $accept  */
  YYSYMBOL_instrlist = 15,                 /* instrlist  */
  YYSYMBOL_instr = 16,                     /* instr  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "PRINT", "SEMICOLON",
  "PLUS", "MINUS", "MULT", "ASSIGN", "OPAR", "CPAR", "ID", "NUM", "UMINUS",
  "$accept", "instrlist", "instr", "expr", YY_NULLPTR
};
